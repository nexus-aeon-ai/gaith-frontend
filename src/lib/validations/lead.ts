...
// Additional Team Members validation
const additionalTeamMembersSchema = z.object({
  software: z.boolean(),
  hardware: z.boolean(),
  consulting: z.boolean(),
  webDesign: z.boolean(),
...
export const createLeadSchema = z.object({
  ...
  youtubeUrl: z.string()
    ...
    .refine((url) => url.includes("youtube.com"), "Must be a YouTube URL")
    .or(z.literal("")),
  ...
  additionalTeamMembers: additionalTeamMembersSchema,
});
