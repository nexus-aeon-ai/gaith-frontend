...
const defaultFormData: CreateClientFormData = {
  ...
  fullName: "",
  industry: "",
  businessOverview: "", // (this is validated as an email in schema, you might want to rename schema field)
  email: "",
  ...
  primaryRegion: "Other", // must be one of: "North America" | "Europe" | "Asia" | "Other"
  targetAudience: "B2B", // must be one of: "B2B" | "B2C" | "Enterprise" | "Startups"
  seondaryMarkets: "",
  languagesSupported: ["English"], // array of enums from `languages`

  // Company profile
  visionStatement: "",
  missionStatement: "",
  clientProductsServicesSchema: {
    socialMedia: false,
    blogCreation: false,
    marketingPlan: false,
  ...
  // Team Assignment
  leadSource: "website", // from clientSourceSchema
  assignedTo: "creative-director", // from assignedToSchema
