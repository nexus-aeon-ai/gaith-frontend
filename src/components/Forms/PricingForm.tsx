          ...
          <Card className="pt-3 rounded-[16px] shadow-none">
            <CardHeader className="px-2">
              <div className="flex items-center justify-between p-4 border-b dark:border-gray-800">
                ...
                <Button className="p-6 px-4 text-white dark:text-black text-[16px] bg-[#3072C0] hover:bg-[#184a86] transition-all font-[400] rounded-[16px] border-[#3072C0] disabled:opacity-50 disabled:cursor-not-allowed">
                  Generate
