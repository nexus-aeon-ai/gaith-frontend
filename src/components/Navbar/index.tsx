...
const Navbar = ({ user }: NavbarProps) => {
  ...
  return (
    <header className="flex sticky top-0 z-50 w-full items-center px-4">
      <div className="flex h-[--header-height] w-full items-center gap-2 pt-1">
        <div className="min-w-full flex items-center justify-between px-2 py-8 bg-background dark:bg-[#06080F] rounded-xl text-foreground shadow h-[85px]">
