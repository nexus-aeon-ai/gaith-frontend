...
const Navbar = ({ user }: NavbarProps) => {
  ...
  return (
    <header className="flex sticky top-0 z-50 bg-[#E4E9F1] dark:bg-[] w-full items-center px-4">
                ...
                <div className="flex min-h-12 gap-2 bg-card border rounded-[24px] px-2 py-1">
                  <Button
                    ...
                    className={`rounded-full border-2 ${
                      themeNext === "light" ? "bg-[#FFD250] border-[#FFD250] hover:bg-[#FFD250]" : "border-transparent"
                    }`}
