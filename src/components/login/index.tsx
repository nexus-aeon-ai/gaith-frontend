...
export default function LoginForm() {
  ...
  return (
    <Card className="w-full shadow-none bg-card rounded-[24px] text-card-foreground p-6">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
            ...
            <div className="mb-2 text-center">
              <Link href="/forget-password" className="text-sm font-medium  hover:underline">
