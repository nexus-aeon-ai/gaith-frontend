...
import { ArrowLeft, BarChart3, CirclePlus, FileSpreadsheet, FolderOpen, Info, Megaphone, Pencil } from "lucide-react";
...
const ClientDetailsView = ({ client, onBack }: ClientDetailsViewProps) => {
  ...
  return (
    <div className={cn(
      ...
      {/* Tabs */}
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full bg-card rounded-xl border border-border" defaultValue="main-info">
