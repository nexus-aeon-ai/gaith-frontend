...
export const DateRangePicker: FC<DateRangePickerProps> & {
  ...
  initialDateFrom = new Date(new Date()),
  initialDateTo,
  initialCompareFrom,
  initialCompareTo,
  onUpdate,
  ...
  const resetValueTo = (initialDateTo: Date | string | undefined): Date => {
    if (initialDateTo) {
      return typeof initialDateTo === "string"
        ? getDateAdjustedForTimezone(initialDateTo)
        : initialDateTo;
    }
    return typeof initialDateFrom === "string"
      ? getDateAdjustedForTimezone(initialDateFrom)
      : initialDateFrom;
  };
    ...
    setRange({
      from:
        typeof initialDateFrom === "string"
          ? getDateAdjustedForTimezone(initialDateFrom)
          : initialDateFrom,
      to: resetValueTo(initialDateTo),
    });
    const getDataTo = (initialCompareTo: string | Date | undefined) => {
      if (initialCompareTo) {
        return typeof initialCompareTo === "string"
          ? getDateAdjustedForTimezone(initialCompareTo)
          : initialCompareTo;
      }
      return typeof initialCompareFrom === "string"
