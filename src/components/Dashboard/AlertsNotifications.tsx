...
const AlertsNotifications = () => (
  <div className="bg-card col-span-1 lg:col-span-4 rounded-lg shadow-md p-4 px-0 w-full text-card-foreground">
          ...
          <div className="flex w-full items-start gap-2">
            ...
            <div className="w-full">
              ...
              <div className="flex gap-2 mt-3">
                ...
                <Button
                  className={`
                    cursor-pointer text-xs px-4 py-2 border-1 hover:bg-transparent shadow-none rounded-[16px] bg-transparent font-medium transition-colors duration-200 
                    ${alert.id ===1 ? "border-[#303444] text-[#303444] dark:text-[#b6b9c3] dark:border-[#b6b9c3]" : "border-[#3072C0] text-[#3072c0]"}
                    `}
                >
                  {alert.actions[1]}
                </Button>
