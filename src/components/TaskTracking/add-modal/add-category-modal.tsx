...
const AddCategoryModal: React.FC<AddCategoryModalProps> = ({ isOpen, onClose, onAddCategory }: AddCategoryModalProps) => {
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="flex flex-col gap-3">
          <Label htmlFor="category-description" className="text-primary-text">Description (Optional)</Label>
          <Textarea 
        ...
        <div className="bg-input border border-border rounded-lg p-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-primary-text">Create a New Category by using AI</span>
          </div>
          <Input 
