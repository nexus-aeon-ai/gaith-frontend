    ...
    <div className="w-full mx-auto p-6">
      ...
      <Breadcrumb className="mb-6">
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbLink asChild>
              <Link href="/quotations" className="text-blue-600 font-medium text-md" onClick={closeNewQuoteForm}>
      ...
      <QuotationForm mode="create" onSubmit={handleSave} onCancel={handleCancel} isSubmitting={isSubmitting} />
    </div>
  );
};
