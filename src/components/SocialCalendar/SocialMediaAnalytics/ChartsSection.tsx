...
export const financialData = [
  { quarter: "Mon", revenue: 68000 },
  { quarter: "Tue", revenue: 72000 },
  { quarter: "Wed", revenue: 85000 },
  { quarter: "Thu", revenue: 78000 },
  { quarter: "Fri", revenue: 78000 },
  { quarter: "Sat", revenue: 78000 },
  { quarter: "Sun", revenue: 78000 },
];
...
const ChartsSection = () => {
  ...
  return (
    <div className="space-y-6 py-4 font-inter">
      {/* Main Charts Grid */}
      <div className="grid grid-cols-1 lg:grid-cols-[2fr_1.1fr] gap-4">
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between p-2">
              <CardTitle className="text-md font-bold">Engagement Trends</CardTitle>
            </div>
          </CardHeader>
        ...
        <Card className="p-0 flex flex-col">
          <CardHeader>
            <div className="flex items-center justify-between p-2">
              <CardTitle className="text-md font-bold">Post Performance By Day</CardTitle>
            </div>
          </CardHeader>
          <Separator className="mb-4" />
            ...
            <div className="w-full h-full">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  />
                  <Bar dataKey="revenue" radius={[16, 16, 16, 16]} barSize={35}>
                    {financialData.map((_, index) => (
                      <Cell key={`cell-${index}`} fill={"#508CD3"} />
                    ))}
                  </Bar>
                </BarChart>
              </ResponsiveContainer>
